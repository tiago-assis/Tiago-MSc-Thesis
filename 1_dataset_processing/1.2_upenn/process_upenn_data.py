    ...
    def __init__(self) -> None:
        ...
        if not os.path.exists(model_path):
            ...
            try:
                ...
                os.system(f"wget 'https://liveuclac-my.sharepoint.com/personal/rmappmb_ucl_ac_uk/_layouts/15/download.aspx?SourceUrl=%2Fpersonal%2Frmappmb%5Fucl%5Fac%5Fuk%2FDocuments%2Fsynthseg%20models%2Fsynthseg%5Frobust%5F2%2E0%2Eh5' -O {model_path}")
            finally:
                if not os.path.exists(model_path):
                    raise FileNotFoundError(f"Failed to download the SynthSeg 2.0 robust model. Please manually download SynthSeg 2.0 robust weights to {model_path} from this link: https://liveuclac-my.sharepoint.com/personal/rmappmb_ucl_ac_uk/_layouts/15/download.aspx?SourceUrl=%2Fpersonal%2Frmappmb%5Fucl%5Fac%5Fuk%2FDocuments%2Fsynthseg%20models%2Fsynthseg%5Frobust%5F2%2E0%2Eh5")
